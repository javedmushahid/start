...
const addContact = async (req, res) => {
  try {
    const { name, email, phoneNumber, message, services } = req.body;
      ...
      html: `
          <div style="font-family: Arial, sans-serif; background-color: #f5f5f5; padding: 20px;">
            <div style="background-color: #ffffff; border-radius: 5px; padding: 20px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
              ...
              <p style="margin-top: 20px; color: #777; font-size: 14px;">Thank you for your query our team will contact you shortly. We appreciate your interest and will get back to you as soon as possible.</p>
            </div>
          </div>
        `,
    };
